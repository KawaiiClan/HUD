...
Scheme
{
	...
	BaseSettings
	{
		...
		Border.Selection				"199 85 252 255"			// the additional border color for displaying the default/selected button

		Button.TextColor				"White"
		Button.BgColor					"255 255 255 8"
		Button.ArmedTextColor			"White"
		Button.ArmedBgColor				"199 85 252 50"
		Button.DepressedTextColor		"White"
		Button.DepressedBgColor			"199 85 252 128"
		Button.FocusBorderColor			"Black"

		CheckButton.TextColor			"White"
		CheckButton.SelectedTextColor		"White"
		CheckButton.BgColor			"5 5 5 200"
		CheckButton.Border1  			"199 85 252 128"		// the left checkbutton border
		CheckButton.Border2  			"199 85 252 128"	// the right checkbutton border
		CheckButton.Check			"LightBlue"	// color of the check itself
		CheckButton.HighlightFgColor		"199 85 252 128"
		CheckButton.ArmedBgColor		"Blank"
		CheckButton.DepressedBgColor		"Blank"
		CheckButton.DisabledBgColor	   	"Blank"

		ComboBoxButton.ArrowColor		"199 85 252 128"
		ComboBoxButton.ArmedArrowColor	"199 85 252 255"
		...
		FrameGrip.Color1				"199 85 252 255"
		FrameGrip.Color2				"0 0 0 100"
		FrameTitleButton.FgColor		"199 85 252 255"
		FrameTitleButton.BgColor		"Blank"
		FrameTitleButton.DisabledFgColor	"199 85 252 128"
		...
		Label.SelectedTextColor			"199 85 252 255" //"White" //The section you have currently selected
		...
		ListPanel.SelectedBgColor			"199 85 252 255"
		ListPanel.SelectedOutOfFocusBgColor	"110 192 255
128"
		...
		Menu.ArmedBgColor				"199 85 252 255"
		Menu.TextInset					"6"

		Panel.FgColor					"255 255 255 255"
		Panel.BgColor					"Blank"

		ProgressBar.FgColor				"199 85 252 128"
		...
		RichText.SelectedBgColor		"199 85 252 255"

		ScrollBar.Wide					"4"

		ScrollBarButton.FgColor				"199 85 252 255"
		ScrollBarButton.BgColor				"Blank"
		ScrollBarButton.ArmedFgColor		"199 85 252 255"
		ScrollBarButton.ArmedBgColor		"Blank"
		ScrollBarButton.DepressedFgColor	"199 85 252 255"
		ScrollBarButton.DepressedBgColor	"TransparentBlack"

		ScrollBarSlider.FgColor				"199 85 252 32"
		...
		Slider.NobColor				"199 85 252 128"
		...
		TextEntry.CursorColor		"199 85 252 255"
