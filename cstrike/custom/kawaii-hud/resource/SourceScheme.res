...
Scheme
{
	...
	Colors
	{
		...
		"Orange"			"239 87 249 255"
		"TransparentBlack"		"5 5 5 100"
		"Black"				"5 5 5 200"
		"LightBlue"			"239 87 249 255"
		"DarkBlue"			"125 218 255 255"

		"Blank"				"0 0 0 0"

		"SteamLightGreen"	"239 87 249 255"
		"AchievementsLightGrey"		"239 87 249 255"
		"AchievementsDarkGrey"		"239 87 249 128"
		"AchievementsInactiveFG"	"130 130 130 255"
		"Yellowish"			"239 87 249 255"
	}
	...
	BaseSettings
	{
		...
		Border.Selection				"239 87 249 255"			// the additional border color for displaying the default/selected button

		Button.TextColor				"White"
		Button.BgColor					"255 255 255 8"
		Button.ArmedTextColor			"White"
		Button.ArmedBgColor				"239 87 249 50"
		Button.DepressedTextColor		"White"
		Button.DepressedBgColor			"239 87 249 128"
		Button.FocusBorderColor			"Black"

		CheckButton.TextColor			"White"
		CheckButton.SelectedTextColor		"White"
		CheckButton.BgColor			"5 5 5 200"
		CheckButton.Border1  			"239 87 249 128"		// the left checkbutton border
		CheckButton.Border2  			"239 87 249 128"	// the right checkbutton border
		CheckButton.Check			"LightBlue"	// color of the check itself
		CheckButton.HighlightFgColor		"239 87 249 128"
		CheckButton.ArmedBgColor		"Blank"
		CheckButton.DepressedBgColor		"Blank"
		CheckButton.DisabledBgColor	   	"Blank"

		ComboBoxButton.ArrowColor		"239 87 249 128"
		ComboBoxButton.ArmedArrowColor	"239 87 249 255"
		...
		FrameGrip.Color1				"239 87 249 255"
		FrameGrip.Color2				"0 0 0 100"
		FrameTitleButton.FgColor		"239 87 249 255"
		FrameTitleButton.BgColor		"Blank"
		FrameTitleButton.DisabledFgColor	"239 87 249 128"
		...
		Label.SelectedTextColor			"239 87 249 255" //"White" //The section you have currently selected
		...
		ListPanel.SelectedBgColor			"239 87 249 255"
		ListPanel.SelectedOutOfFocusBgColor	"239 87 249 128"
		ListPanel.EmptyListInfoTextColor	"150 150 150 255"

		Menu.TextColor					"White"
		Menu.BgColor					"0 0 0 120"
		Menu.ArmedTextColor				"Black"
		Menu.ArmedBgColor				"239 87 249 255"
		Menu.TextInset					"6"

		Panel.FgColor					"DullWhite"
		Panel.BgColor					"Blank"

		ProgressBar.FgColor				"239 87 249 128"
		...
		ScrollBarButton.FgColor				"239 87 249 128"
		ScrollBarButton.BgColor				"Blank"
		ScrollBarButton.ArmedFgColor		"239 87 249 255"
		ScrollBarButton.ArmedBgColor		"Blank"
		ScrollBarButton.DepressedFgColor	"239 87 249 255"
		ScrollBarButton.DepressedBgColor	"TransparentBlack"

		ScrollBarSlider.FgColor				"239 87 249 32"
		...
		Slider.NobColor				"239 87 249 128"
		...
		TextEntry.CursorColor		"239 87 249 255"
	...
	Fonts
	{
		...
		"DefaultFixedOutline" //edited by INsane 2010 for small netgraph font on all screen sizes
		{
			...
			"2" //For screen heights between 600 and 767 (eg 4:3 aspect Width 800X600 High, ... 16:9 aspect Width 1152x648 High.)
			{
				...
				"name"		 "Georgia" [$POSIX] // Apple Mac OS "Verdana" (default) Best small font = "Georgia" Mac Installation location: /Library/Fonts and is default on Mac OS
				"tall"		 "19" [$POSIX]  // "11"				
				"tall"		 "19" //good positioning is ... "net_graphpos 190" and "net_graphheight 45" and ensure you select "antialias"  "1" with all others off with "Georgia" font.
				"tall_lodef" "15" //"15"
				"tall_hidef" "20" //"20"				
				"weight"	 "0"
				"range"		 "0x0000 0x017F" //	Basic Latin, Latin-1 Supplement, Latin Extended-A
...
//			}
	...
	Borders
	{
		...
		FrameBorder
		{
			...
			Left
			{
				...
				"2"
				{
					"color" "239 87 249 50" //"Border.Dark"
					"offset" "1 1"
				}
			}
	...
	CustomFontFiles
	{
		...
		"4"		"resource/fonts/Gravity-Regular.ttf"
		"5"		"resource/fonts/Gravity-Regular.ttf"
		"6"		"resource/fonts/Gravity-Regular.ttf"
		"7"
		{
			"name" "Gravity-Regular"
